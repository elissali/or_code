...
from utils import mkdir_p, weights_init, save_model, norm
...
class RatingModel(object):
    ...
    def __init__(self, cfg, output_dir):
        ...
        if self.cfg.PREDICTION_TYPE == 'discrete_distrib':
            ...
            def gnll_loss(y, means, stds, weights, batched=True):
                if batched == False:
    ...
    def load_network(self):
        ...
        if self.load_checkpoint != "":
            print("load checkpoint: ", self.load_checkpoint)
    ...
    def validation(self, X_val, y_val, L_val=None):
            ...
            for i, inds in enumerate(batch_inds, 0):
                ...
                for s in sort_idx:
                    if self.cfg.PREDICTION_TYPE == 'beta_distrib' or self.cfg.PREDICTION_TYPE == "mean_var":
                        ...
                        temp_rating[s] = output_scores[cnt]             # [6-dim of mean1, mean2, std1, std2, weight1, weight2]
                    cnt += 1
        ...
        if self.cfg.PREDICTION_TYPE == 'discrete_distrib':
            ...
            # y_preds_lst = (batch_size, 6)  i.e. the (mean_1, mean_2, std_1, std_2, weight1, weight2)
